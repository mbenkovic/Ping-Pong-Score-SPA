...
(function () {
  ...
  function navigate(){
    ...
    // if (fragmentId === "players"){
    //   $("#view_script").attr("src", "/ppsingle/js/players.js");
    // }

    // if (fragmentId === "score_tracker"){
    //   $("#view_script").attr("src", "/ppsingle/js/score_tracker.js");
    // }
    
    // if (fragmentId === "games_played"){
    //   $("#view_script").attr("src", "/ppsingle/js/games_played.js");
    // }

    // if (fragmentId === "home" || fragmentId === "leaderboard"){
    //   $("#view_script").removeAttr("src");
    // }
